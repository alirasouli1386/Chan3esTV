        ...
        <div class="col-md-5 offset-md-1">
          ...
          <div class="row">
            ...
            <div class="col-md">
              ...
              <h4 class="text-left text-white">Singer: {{$singer_au}}</h4>
              <h4 class="text-left text-white">Composer: {{$composer_au}}</h4>
              <h4 class="text-left text-white">Artist(s): {{$artist_au}}</h4>
              <h4 class="text-left text-white">Album: {{$album_au}}</h4>
        ...
        <div class="col-md-5" style="direction:rtl">
          ...
          <div class="row">
            ...
            <div class="col-md">
              ...
              <h4 class="farsi text-right text-white">خواننده: {{$singer_au}}</h4>
              <h4 class="farsi text-right text-white">نوازنده: {{$composer_au}}</h4>
              <h4 class="farsi text-right text-white">موسیقی از {{$artist_au}}</h4>
              <h4 class="farsi text-right text-white">آلبوم: {{$album_fa}}</h4>
            </div>
          </div>
          <div class="row">
