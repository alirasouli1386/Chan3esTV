...
@section('content')
  <div class="jumbotron" style="background:whitesmoke;">
    <h1 class="display-4 offset-md-1" ><strong>MUSICS</strong></h1>
  </div>
        ...
        @foreach($musics as $music)
          <div class="col-sm-4 col-md-3 py-sm-1">
            <div class="card h-100">
              <a class="card-anchor" href="{{route('show_music', [ 'music_id' => $music->id ])}}">
                <img src="{{asset('img/tv/musics/'.$music->thumbnail_image_route)}}" class="card-img-top"/>
                <div class="card-body">
                  <h4 class="card-title">
                    {{$music->name_au}}
                  </h4>
