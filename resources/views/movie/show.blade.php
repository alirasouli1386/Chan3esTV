        ...
        <div class="col-md-5" style="direction:rtl">
          ...
          <div class="row">
            ...
            <div class="col-md">
              ...
              <h4 class="farsi text-right text-white">کشور سازنده: {{$production_country_fa}}</h4>
              <h4 class="farsi text-right text-white">تهیه‌کننده(گان){{$producers_fa}}</h4>
              <h4 class="farsi text-right text-white">کارگردان(ان) {{$directors_fa}}</h4>
              <h4 class="farsi text-right text-white">هنرپیشگان {{$actors_fa}}</h4>
