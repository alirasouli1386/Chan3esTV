...
class CreateMusicsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('musics', function (Blueprint $table) {
          ...
          $table->string('singer_au')->default('');
          $table->string('singer_fa')->charset('utf8')->default('');
          $table->string('composer_au')->default('');
          $table->string('composer_fa')->charset('utf8')->default('');
          $table->string('artist_au')->default('');
          $table->string('artist_fa')->charset('utf8')->default('');
          $table->string('album_au')->default('');
          $table->string('album_fa')->charset('utf8')->default('');
